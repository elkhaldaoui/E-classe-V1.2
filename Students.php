                                ...
                                <tbody>
                                    <?php
                                     ...
                                     '<tr> 
                                        ...
                                        <td>
                                        <a href="edite.php?id='.$row['id'].'"><svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number"  name="enroll_Number"  class="form-control" id="InputEnrollNumber" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
